...
/**
 * คำโปรยและวิธีเล่นบนหน้าแรก เปลี่ยนตามเกมที่เลือก
 * ชื่อ "BOARD GAME" ด้านบนเป็นชื่อแอป ไม่เปลี่ยนตามเกม อยู่ใน index.html ตรง ๆ
 * ชื่อเกมที่เลือกอยู่เห็นได้จากชิปที่ไฮไลต์ กับหัวข้อของกล่องวิธีเล่น
 */
function paintHomeGame() {
  var g = metaOf(MY_GAME);
  var u = GAME_UI[MY_GAME] || GAME_UI.spyfall;
  // คำโปรยใต้ชื่อแอปเป็นของ "แอป" ไม่ใช่ของเกม ไม่งั้นจะอ่านเหมือน Board Game เป็นเกมสายลับ
  // คำโปรยของเกมที่เลือกย้ายไปอยู่ในกล่องวิธีเล่นแทน ข้อมูลไม่หาย และหัวหน้าเพจไม่ขัดกันเอง
  $('rules-title').textContent = 'เล่นยังไง · ' + g.name;
  $('rules-sub').textContent = g.tagline;
